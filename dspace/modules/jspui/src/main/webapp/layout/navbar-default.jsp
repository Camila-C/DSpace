...
<nav class="collapse navbar-collapse bs-navbar-collapse">
  ...
  <div class="nav navbar-nav navbar-right">
    ...
    %>
          <li>
            <a onclick="javascript:document.repost.locale.value='<%=supportedLocales[i].toString()%>';document.repost.submit();"
                href="<%= request.getContextPath() %>?locale=<%=supportedLocales[i].toString()%>"><%= supportedLocales[i].getDisplayLanguage(supportedLocales[i])%>
            </a>
          </li>
    <%
        }
  ...
  <div class="nav navbar-nav navbar-right">
    ...
    <form method="get" action="<%= request.getContextPath() %>/simple-search" class="navbar-form navbar-right">
      ...
      <button type="submit" class="d-inline btn btn-primary">
