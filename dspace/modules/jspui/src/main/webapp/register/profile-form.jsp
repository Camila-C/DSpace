...
%>
  <div class="form-group col-md-6">
    <label for="tfirst_name"><fmt:message key="jsp.register.profile-form.fname.field"/></label>
    <input class="form-control" type="text" name="first_name" id="tfirst_name" size="40" value="<%= Utils.addEntities(firstName) %>"/>
  </div>
  <div class="form-group col-md-6">
    <label for="tlast_name"><fmt:message key="jsp.register.profile-form.lname.field"/></label>
    <input class="form-control" type="text" name="last_name" id="tlast_name" size="40" value="<%= Utils.addEntities(lastName) %>" />
  </div>
  <div class="form-group col-md-6">
    <label for="tphone"><fmt:message key="jsp.register.profile-form.phone.field"/></label>
    <input class="form-control" type="text" name="phone" id="tphone" size="40" maxlength="32" value="<%= Utils.addEntities(phone) %>"/>
  </div>
  <div class="form-group col-md-6">
